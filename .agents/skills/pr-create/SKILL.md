...
5. Require a clean worktree before publishing. Commit the task's reviewed changes when needed; preserve unrelated user changes. Untracked files selected solely as PR attachments are the only permitted exception.
