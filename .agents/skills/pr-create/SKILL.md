...
5. Resolve evidence before changing remote state:
   ...
   - Use a plain absolute path for video attachments. The `#alt text` suffix is supported only for images; adding it to a video causes the CLI to reject publication.
