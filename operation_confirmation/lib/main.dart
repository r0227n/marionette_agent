...
void main() {
  ...
  operationLogCollector.addLog('operation_confirmation started');
  runApp(const OperationConfirmationApp());
}

class OperationConfirmationApp extends StatelessWidget {
  const OperationConfirmationApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const OperationConfirmationScreen(),
    );
  }
}
...
class OperationConfirmationScreen extends StatefulWidget {
  ...
  @override
  State<OperationConfirmationScreen> createState() =>
      _OperationConfirmationScreenState();
}

class _OperationConfirmationScreenState
    extends State<OperationConfirmationScreen> {
  int _tapCount = 0;
  int _pageIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Operation confirmation')),
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                TextField(
                  ...
                  onChanged: (value) {
                    setState(() => _inputStatus = '${value.length} characters');
          ...
          _Section(
            ...
            child: _dismissibleVisible
                ...
                : const Text('Item dismissed', key: ValueKey('dismiss_result')),
          ),
